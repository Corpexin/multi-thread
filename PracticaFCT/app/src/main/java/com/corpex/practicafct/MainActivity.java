...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, nuevo_alumno.OnFragmentInteractionListener {
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nuevo_alumno) {
            ...
            getFragmentManager().beginTransaction().replace(R.id.content, frg, "Nuevo Alumno").commit();
